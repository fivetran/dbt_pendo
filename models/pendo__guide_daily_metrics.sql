...
final as (
    ...
    {% set exclude_fields = ['source_relation', 'guide_id', 'occurred_on'] %}

    select
        guide_spine.source_relation,
    ...
    left join daily_metrics
        on guide_spine.source_relation = daily_metrics.source_relation
        and guide_spine.date_day = daily_metrics.occurred_on
