{% macro pendo_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}

{{ adapter.dispatch('pendo_union_connections', 'pendo') (connection_dictionary, single_source_name, single_table_name, default_identifier) }}

{%- endmacro %}

{% macro default__pendo_union_connections(connection_dictionary, single_source_name, single_table_name, default_identifier=single_table_name) %}
...
{# For unioning #}
    ...
    {%- if relations != [] -%}
        {{ pendo.pendo_union_relations(relations) }}
