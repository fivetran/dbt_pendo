...
[PR #41](https://github.com/fivetran/dbt_pendo/pull/41) includes the following updates:
...
- Removed the dependency on the `fivetran/pendo_source` package.
  ...
  - Update any pendo_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_pendo/blob/main/README.md#optional-step-4-additional-configurations) for how to configure the build schema of staging models.
