...
- Removed the dependency on the `fivetran/pendo_source` package.
  ...
  - Update any pendo_source-scoped variables to be scoped to only under this package. See the [README](https://github.com/fivetran/dbt_pendo/blob/main/README.md) for how to configure the build schema of staging models.
